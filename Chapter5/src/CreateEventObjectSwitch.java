//Filename CreateEventObjectSwitch.java
//Written by krycess
//Written on Oct 10, 2012

import java.util.Scanner;

public class CreateEventObjectSwitch {
...
switch(eventType)
{
    ...
    default:
        ...
        if(choiceIsGood)
        {
            ...
            System.out.println("You enetered " + eventType + " which is invalid.");
        
        System.out.println("Scheduled event:");
        System.out.println("Type: " + scheduledEvent.getType() +
                " Manager: " + scheduledEvent.getManager() +
                " Rate: " + scheduledEvent.getRate() + " per hour");
    }
}
